...
@interface GridMenuViewController : UIViewController <UIGestureRecognizerDelegate, GridMenuScrollViewDelegate, UIScrollViewDelegate>

+ (instancetype)visibleGridMenu;

@property (nonatomic, readonly) UIView *menuView;

@property (nonatomic, readonly) GridMenuScrollView* scrollView;
