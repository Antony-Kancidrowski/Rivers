...
@interface TexturedBackgroundNode ()
{
...
@implementation TexturedBackgroundNode

+ (TexturedBackgroundNode *)backgroundWithTextureNamed:(NSString *)textureName {
    
    TexturedBackgroundNode *newBackground = [[TexturedBackgroundNode alloc] initWithTextureNamed:textureName];
